        ...
        try:
            with DBconnection() as mc_afficher:
                if order_by == "ASC" and id_genre_sel == 0:
                    strsql_genres_afficher = """SELECT * FROM t_cours"""
                    ...
                    strsql_genres_afficher = """SELECT * FROM t_eleve WHERE id_eleve = %(value_id_eleve_selected)s"""
                ...
                if not data_genres and id_genre_sel == 0:
                    ...
                    flash(f"Le cour demandé n'existe pas !!", "warning")
                else:
                    # Dans tous les autres cas, c'est que la table "t_genre" est vide.
                    # OM 2020.04.09 La ligne ci-dessous permet de donner un sentiment rassurant aux utilisateurs.
                    flash(f"Données cours affichés !!", "success")
    ...
    if request.method == "POST":
        try:
            if form.validate_on_submit():
                name_genre_wtf = form.nom_wtf.data
                name_genre = name_genre_wtf.lower()
                prenom_pers = form.prenom_genre_wtf.data
                ...
                strsql_insert_genre = """INSERT INTO t_cours (id_cours,nom_cours,document) VALUES (NULL,%(value_intitule_genre)s,%(value_prenom_pers)s) """
...
def genre_update_wtf():
    ...
    try:
        ...
        if form_update.validate_on_submit():
            ...
            str_sql_update_intitulegenre = """UPDATE t_cours SET nom_cours = %(value_name_genre)s, 
            document = %(value_date_genre_essai)s WHERE id_cours = %(value_id_genre)s """
            with DBconnection() as mconn_bd:
            ...
            str_sql_id_genre = "SELECT id_cours, nom_cours, document FROM t_cours " \
                               "WHERE id_cours = %(value_id_genre)s"
            ...
            form_update.nom_genre_update_wtf.data = data_nom_genre["nom_cours"]
            form_update.date_genre_wtf_essai.data = data_nom_genre["document"]
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_del.data:
                ...
                str_sql_delete_films_genre = """DELETE FROM t_eleve WHERE id_eleve = %(value_id_genre)s"""
                str_sql_delete_idgenre = """DELETE FROM t_eleve WHERE id_eleve = %(value_id_genre)s"""
        ...
        if request.method == "GET":
            ...
            with DBconnection() as mydb_conn:
                ...
                # Opération sur la BD pour récupérer "id_genre" et "intitule_genre" de la "t_genre"
                str_sql_id_genre = "SELECT id_cours, nom_cours FROM t_cours WHERE id_cours = %(value_id_genre)s"
