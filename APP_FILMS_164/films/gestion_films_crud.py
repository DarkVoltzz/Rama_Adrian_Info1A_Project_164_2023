...
Test : exemple: cliquer sur le menu "Films/Éleves" puis cliquer sur le bouton "ADD" d'un "film"
...
Test : exemple: cliquer sur le menu "Films/Éleves" puis cliquer sur le bouton "EDIT" d'un "film"
...
def film_update_wtf():
    ...
    try:
        ...
        if form_update_film.validate_on_submit():
            ...
            str_sql_id_film = "SELECT * FROM t_cours WHERE id_cours = %(value_id_film)s"
